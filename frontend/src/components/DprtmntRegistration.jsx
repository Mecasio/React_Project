...
import { Container, Dialog, DialogTitle, DialogActions, DialogContent, Menu, MenuItem } from "@mui/material";
  ...
  return (
    <Container className="container">
      ...
      <Menu id="menu" anchorEl={openMenu} open={Boolean(openMenu)} onClose={handleCloseModal}>
        <MenuItem style={{fontSize: '16px'}}>Edit Program</MenuItem>
        <MenuItem style={{fontSize: '16px'}}>Delete Program</MenuItem>
      </Menu>
